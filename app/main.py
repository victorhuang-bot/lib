...
def migrate_v1929(c):
    """V19.2.19: void metadata, carried items and editable receipt time."""
    ...
    if USE_POSTGRES:
        ...
        # V19.2.19: Oregon/Singapore may auto-deploy the same commit concurrently
